            ...
            <div className="skills-wrapper">
              ...
              <div className="skills-group">
                ...
                <div className="skills-container">
                  ...
                  <div className="skill-item floating" style={{ animationDelay: '0.4s' }}><img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/tailwindcss/tailwindcss-original.svg" alt="Tailwind CSS" /><span>Tailwind CSS</span></div>
                  <div className="skill-item floating" style={{ animationDelay: '0.6s' }}><i className="fab fa-js" style={{ color: '#F7DF1E' }}></i><span>JavaScript</span></div>
                  <div className="skill-item floating" style={{ animationDelay: '0.8s' }}><i className="fab fa-react" style={{ color: '#61DAFB' }}></i><span>React (Learning)</span></div>
                </div>
              </div>
              ...
              <div className="skills-group">
                ...
                <div className="skills-container">
                  <div className="skill-item floating" style={{ animationDelay: '1.0s' }}><i className="fab fa-git-alt" style={{ color: '#F05032' }}></i><span>Git</span></div>
                  <div className="skill-item floating" style={{ animationDelay: '1.2s' }}><i className="fab fa-aws" style={{ color: '#FF9900' }}></i><span>AWS (Basic)</span></div>
                  <div className="skill-item floating" style={{ animationDelay: '1.4s' }}><i className="fas fa-network-wired" style={{ color: '#00D1B2' }}></i><span>REST API</span></div>
                </div>
              </div>
