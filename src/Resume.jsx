      ...
      >
        ...
        <div style={{ marginBottom: "15px" }}>
          ...
          <p style={{ margin: "0", fontSize: "13px", color: "#444" }}>
            6360744922 | nageshl15260@gmail.com | Chamarajanagara |
            https://nageshl-portfolio.vercel.app/
          </p>
        </div>

        {/* Thick Golden Line */}
        <div
          style={{ borderBottom: "3px solid #d4af37", marginBottom: "20px" }}
        ></div>
        ...
        <div style={{ marginBottom: "20px" }}>
          ...
          >
            Motivated BCA student with foundational knowledge of HTML, CSS,
            JavaScript, and currently learning React.js. Passionate about
            building responsive and user-friendly web applications. Eager to
            apply frontend development skills in a real-world environment and
        ...
        <div style={{ marginBottom: "25px" }}>
          ...
          <div style={{ marginBottom: "18px" }}>
            ...
            >
              <li>
                Built a responsive web application using HTML, CSS, and
                JavaScript
              </li>
          ...
          <div style={{ marginBottom: "18px" }}>
            ...
            >
              ...
              <li>
                Utilized AI tools for debugging and improving functionality
              </li>
        ...
        <div style={{ marginBottom: "25px" }}>
          ...
          <p style={{ margin: "0 0 2px 0", fontSize: "13px", color: "#222" }}>
        ...
        <div style={{ marginBottom: "15px" }}>
          ...
          >
            ...
            <li>
              Currently learning <strong>React.js</strong> and modern frontend
              development
            </li>
            <li>
              Familiar with <strong>Git</strong> and <strong>GitHub</strong> for
              version control
            </li>
            <li>
              Experience in working with <strong>REST API</strong>s and
